...
namespace Gibbed.RED4.ScriptFormats.Instructions
{
    ...
    internal struct SwitchLabel_Offset
    {
        ...
        public SwitchLabel_Offset(short falseOffset, short trueOffset)
        {
        ...
        internal static (object, uint) Read(IDefinitionReader reader)
        {
            ...
            return (new SwitchLabel_Offset(falseOffset, trueOffset), 4);
        }

        internal static uint Write(object argument, IDefinitionWriter writer)
        {
            var (falseOffset, trueOffset) = (SwitchLabel_Offset)argument;
