    ...
    internal static class InstructionHandlers
    {
        ...
        static InstructionHandlers()
        {
            _Lookup = new Dictionary<Opcode, (ReadDelegate, WriteDelegate)>(256)
            {
                ...
                { Opcode.ArraySize, (_DefinitionRef<NativeDefinition>.Read, _DefinitionRef<NativeDefinition>.Write) },
                ...
                { Opcode.ArrayContains, (_DefinitionRef<NativeDefinition>.Read, _DefinitionRef<NativeDefinition>.Write) },
                ...
                { Opcode.ArrayInsert, (_DefinitionRef<NativeDefinition>.Read, _DefinitionRef<NativeDefinition>.Write) },
                ...
                { Opcode.ArrayElement, (_DefinitionRef<NativeDefinition>.Read, _DefinitionRef<NativeDefinition>.Write) },
